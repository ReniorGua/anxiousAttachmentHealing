...
import GroundingFiveSenses from '@/views/ai/components/GroundingFiveSenses.vue'
...
import AffirmationEcho from '@/views/ai/components/AffirmationEcho.vue'
import WaitingTimer from '@/views/ai/components/WaitingTimer.vue'
import ThirtyDaysAffirmation from '@/views/ai/components/ThirtyDaysAffirmation.vue'
import FearRelease from '@/views/ai/components/FearRelease.vue'
import PersonalLaw from '@/views/ai/components/PersonalLaw.vue'
import BirthMemory from '@/views/ai/components/BirthMemory.vue'
import ResistanceExhaustion from '@/views/ai/components/ResistanceExhaustion.vue'
import DeepRelease from '@/views/ai/components/DeepRelease.vue'
import FutureVision from '@/views/ai/components/FutureVision.vue'
